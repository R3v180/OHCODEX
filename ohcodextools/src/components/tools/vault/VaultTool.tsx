...
import { Lock, Unlock, Eye, EyeOff, Copy, CheckCircle2, XCircle, Upload, Download, Shield } from 'lucide-react'
            ...
            <TabsContent value="file" className="space-y-6">
              ...
              <Card className="bg-zinc-900/50 border-border">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div
                    className={`border-2 border-dashed rounded-lg p-8 text-center transition-colors ${
                      file
                        ...
                        : 'border-border hover:border-cyan-500/50 hover:bg-cyan-500/5 cursor-pointer'
                    }`}
                  ...
                  >
                    ...
                    {file ? (
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-foreground">{t('dragHere')}</p>
                  ...
                  {/* Password Input */}
                  <div className="space-y-2">
                    <Label htmlFor="file-password">{t('encryptionPassword')}</Label>
                    <div className="relative">
                      <Input
                        id="file-password"
