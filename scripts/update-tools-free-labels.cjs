// CommonJS script to enforce "gratis/free" wording
// in tools_locales.title and tools_locales.short_description
// across all supported locales, plus a simple badge when empty.
