...
import { Lock, Image as ImageIcon, FileText, Database, QrCode, ArrowRight, Shield, Box, LucideIcon, ScanLine, Code, Palette, Key, KeyRound, Dna, SplitSquareHorizontal } from 'lucide-react'
...
const BADGE_STYLES: Record<string, string> = {
  ...
  'file-carver': 'bg-teal-900/50 text-teal-400 border-teal-800',               // Teal - Carver
  'hex-diff': 'bg-yellow-900/50 text-yellow-400 border-yellow-800',            // Amarillo - Diff
