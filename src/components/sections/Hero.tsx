...
// Versión: 1.0.0 - Diseño inicial con Grid Background y Gradientes CSS
// Descripción: Sección principal de la Landing Page. Usa Shadcn UI buttons.
// -----------------------------------------------------------------------------

import React from 'react'
import Link from 'next/link'
import { Button } from '@/components/ui/button'
import { ArrowRight, Code2, Layers } from 'lucide-react' // Iconos ligeros
...
export function Hero() {
  return (
    <section className="relative flex min-h-[90vh] flex-col items-center justify-center overflow-hidden border-b border-white/10 bg-black pt-20">
      ...
      {/* 1. FONDO TECNOLÓGICO (GRID + GLOW) */}
      <div className="absolute inset-0 z-0">
        {/* Malla cuadrada sutil */}
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f2e_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)]" />
        {/* Resplandor Cyan central superior */}
      ...
      <div className="container relative z-10 px-4 text-center">
        ...
        {/* 2. BADGE SUPERIOR "En Desarrollo" */}
        <div className="mb-6 inline-flex items-center rounded-full border border-cyan-500/30 bg-cyan-500/10 px-3 py-1 text-sm text-cyan-300 backdrop-blur-sm">
          ...
          Nuevo: Pool-Control Beta Disponible
        </div>
        ...
        <p className="mx-auto mt-6 max-w-2xl text-lg text-zinc-400 md:text-xl">
          Transformamos negocios con software a medida de alto rendimiento. 
          Desde PWAs ultra-rápidas hasta infraestructuras SaaS complejas.
        </p>

        {/* 5. BOTONES DE ACCIÓN (CTA) */}
        ...
        {/* 6. INDICADORES DE TECNOLOGÍA (Social Proof) */}
...
// -----------------------------------------------------------------------------
// Fin archivo: src/components/sections/Hero.tsx
// -----------------------------------------------------------------------------